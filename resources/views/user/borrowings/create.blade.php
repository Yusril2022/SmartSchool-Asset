...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <form action="{{ route('borrowings.store') }}" method="POST" class="space-y-5">
        ...
        <div>
            ...
            <input type="text" name="tujuan_pinjam" value="{{ old('tujuan_pinjam') }}"
                placeholder="Contoh: Kegiatan praktikum kelas X, Rapat dinas, dll"
                class="w-full border border-gray-300 rounded-xl px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 @error('tujuan_pinjam') border-red-400 @enderror">
            @error('tujuan_pinjam')
